!function () {
    "use strict";
    var n, e, t, r, o, a, c, i, s, u, f, p, l, d, v = {
        26: function (n, e, t) {
            t.d(e, {
                Z: function () {
                    return i
            ...
            var r = t(537), o = t.n(r), a = t(645), c = t.n(a)()(o());
            c.push([n.id, "body{color:blue}", "", {
                version: 3,
                sources: ["webpack://./src/sass/style.scss"],
                names: [],
                mappings: "AAEA,KACE,UAHW",
                sourcesContent: ["$body-color: blue;\r\n\r\nbody {\r\n  color: $body-color;\r\n}"],
                sourceRoot: ""
            }]);
            const i = c
        }, 645: function (n) {
            n.exports = function (n) {
                ...
                return e.toString = function () {
                    ...
                    for (var u = 0; u < n.length; u++) {
                        var f = [].concat(n[u]);
                        r && c[f[0]] || (void 0 !== a && (void 0 === f[5] || (f[1] = "@layer".concat(f[5].length > 0 ? " ".concat(f[5]) : "", " {").concat(f[1], "}")), f[5] = a), t && (f[2] ? (f[1] = "@media ".concat(f[2], " {").concat(f[1], "}"), f[2] = t) : f[2] = t), o && (f[4] ? (f[1] = "@supports (".concat(f[4], ") {").concat(f[1], "}"), f[4] = o) : f[4] = "".concat(o)), e.push(f))
                    }
                }, e
            }
        }, 537: function (n) {
            ...
            function r(n, r) {
                for (var a = {}, c = [], i = 0; i < n.length; i++) {
                    var s = n[i], u = r.base ? s[0] + r.base : s[0], f = a[u] || 0, p = "".concat(u, " ").concat(f);
                    a[u] = f + 1;
                    var l = t(p), d = {css: s[1], media: s[2], sourceMap: s[3], supports: s[4], layer: s[5]};
                    if (-1 !== l) e[l].references++, e[l].updater(d); else {
                        var v = o(d, r);
                        r.byIndex = i, e.splice(i, 0, {identifier: p, updater: v, references: 1})
                    }
                    c.push(p)
                }
                return c
    ...
    function y(n) {
        ...
        return v[n](t, t.exports, y), t.exports
    }
    ...
    }, y.nc = void 0, n = y(379), e = y.n(n), t = y(795), r = y.n(t), o = y(569), a = y.n(o), c = y(565), i = y.n(c), s = y(216), u = y.n(s), f = y(589), p = y.n(f), l = y(26), (d = {}).styleTagTransform = p(), d.setAttributes = i(), d.insert = a().bind(null, "head"), d.domAPI = r(), d.insertStyleElement = u(), e()(l.Z, d), l.Z && l.Z.locals && l.Z.locals
}();
